...
router.post('/',                auth, isAdmin, upload.fields([{ name: 'cover', maxCount: 1 }, { name: 'book_file', maxCount: 1 }, { name: 'preview_file', maxCount: 1 }]), ctrl.createBook);
router.put('/:id',              auth, isAdmin, upload.fields([{ name: 'cover', maxCount: 1 }, { name: 'book_file', maxCount: 1 }, { name: 'preview_file', maxCount: 1 }]), ctrl.updateBook);
